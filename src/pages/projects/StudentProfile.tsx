...
export function StudentProfile() {
    ...
    return (
      <PageTransition>
        <div className="text-center py-20">
          ...
          <Button onClick={() => navigate('/projects/students')} variant="outline" size="sm"><ArrowLeft size={14} className="mr-1" /> Voltar</Button>
        </div>
      </PageTransition>
    );
  }
  ...
  return (
    <PageTransition>
      <button onClick={() => navigate('/projects/students')} className="flex items-center gap-1.5 text-sm font-semibold text-blue-600 hover:underline mb-4">
